 ...
 */
public class EncodecRender implements WEGLSurfaceView.GLRender {

    private static final String TAG = "EncodecRender";
    ...
    public EncodecRender(Context ctx, int textureId){
        context = ctx;
        textureid = textureId;

        //bitmap = ShaderUtil.createTextImage("视频水印 EncodecRender water 202012", 50, "#ff0000", "#00000000", 0);
        //bitmap = ShaderUtil.createTextImage("视频CameraFboRender：202012", 50, "#ff0000", "#00000000", 0);
        bitmap = ShaderUtil.createLocalTimeImage(50, "#ff0000", "#00000000", 0);
